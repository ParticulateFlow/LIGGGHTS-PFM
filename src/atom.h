...
class Atom : protected Pointers {
 public:
  ...
  int **bond_type;
  int **bond_atom;
  double ***bond_hist; //NP modified C.K.
  ...
  int **ivector;
  double **dvector;
  double ***darray; //NP modified C.K.
  char **iname,**dname,**daname; //NP modified C.K.
  int nivector,ndvector, ndarray; //NP modified C.K.
  ...
  int density_flag; //NP modified C.K.
  int p_flag;  //NP modified A.A.
  int n_bondhist; //NP modified C.K.
  int radvary_flag; //NP modified C.K.
  ...
  void *extract(const char * _id) //NP modified C.K.
  {
      int a = 0;
