...
class AtomVec : protected Pointers {
 public:
  ...
  virtual void pack_data(double **buf,int tag_offset) { pack_data(buf); } //NP modified C.K.
  ...
  virtual void pack_vel(double **buf,int tag_offset) { pack_vel(buf); } //NP modified C.K.
