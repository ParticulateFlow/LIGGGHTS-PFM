...
AtomStyle(angle/gran,AtomVecAngleGran)

#else

#ifndef LMP_ATOM_VEC_ANGLE_GRAN_H
#define LMP_ATOM_VEC_ANGLE_GRAN_H

#include "atom_vec.h"

namespace LAMMPS_NS {

class AtomVecAngleGran : public AtomVec {
 public:
  AtomVecAngleGran(class LAMMPS *);
