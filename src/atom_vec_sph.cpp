      ...
      AtomVec(lmp)
{
  ...
  comm_x_only = 0; //NP also communicate p and rho
  comm_f_only = 0; //NP communication of drho and de
  size_forward = 9; //NP 3 position + p + rho + e + vest[3]
  size_reverse = 5; //NP 3 force + drho + de
  size_border = 12;  //NP 3 pos, tag, type, mask, p, rho, e, vest[3]
  size_velocity = 3; //NP 3 vel
  size_data_atom = 6; //NP TODO:
  size_data_vel = 7; //NP TODO:
  xcol_data = 5;
