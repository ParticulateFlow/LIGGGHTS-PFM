...
ComputeERotateSuperquadric::ComputeERotateSuperquadric(LAMMPS *lmp, int narg, char **arg) :
  Compute(lmp, narg, arg)
{
  if (narg < 3) error->all(FLERR,"Illegal compute erotate/superquadric command");
