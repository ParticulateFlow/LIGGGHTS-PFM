  ...
  fix_tracer_(0)
{
    ...
    while(iarg < narg && hasargs)
    {
        ...
        if(strcmp(arg[iarg],"periodic") == 0) {
            ...
            /*NL*/ //printVec3D(screen,"domain->periodicity",domain->periodicity);
            /*NL*/ //fprintf(screen,"image_dim_ %d\n",image_dim_);
...
void ComputeNparticlesTracerRegion::init()
{
    ...
    /*NL*/ //fprintf(screen,"fix_tracer_name_ %s\n",fix_tracer_name_);
...
double ComputeNparticlesTracerRegion::compute_scalar_eval()
{
    ...
    {
        //NP check for image flag
        //NP (image[i] & 1023) - 512 is xbox, etc.
        /*NL*/ //if(i==0)fprintf(screen,"image %d %d %d\n",(image[i] & 1023) - 512,((image[i] >> 10 & 1023) - 512),((image[i] >> 20) - 512));
