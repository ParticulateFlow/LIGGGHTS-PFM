...
FixStyle(contacthistory/mesh,FixContactHistoryMesh) //NP for use by pair Style Neigh class references to this fix
...
class FixContactHistoryMesh : public FixContactHistory {
 ...
 public:
  ...
  /*NL*/ void debug(int iPart, int idTri);
 ...
 protected:
  ...
  //NP use ipage_, ipage2_, dpage_, dpage2_ to alternate
  //NP between 2 paged data structure.
  //NP alternation is performed after re-neighboring
  //NP and avoids to end up with ragged, ever-growing i/dpages.
