...
class FixNeighlistMesh : public Fix
{
  public:
    ...
    virtual void pre_neighbor(); //NP sets flag that tri neigh list shall be built
  ...
  private:
    ...
    //NP numContacts is the # of contacts for each element
    //NP contactList is a list witz all contacts
    //NP where the first numContacts[0] elements belong to element 0
    //NP the next numContacts[1] elements belong to element 1 etc
