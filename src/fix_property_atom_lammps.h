...
FixStyle(property/atom/lammps,FixPropertyAtomLammps)

#else

#ifndef LMP_FIX_PROPERTY_ATOM_LAMMPS_H
#define LMP_FIX_PROPERTY_ATOM_LAMMPS_H

#include "fix.h"

namespace LAMMPS_NS {

class FixPropertyAtomLammps : public Fix {
 public:
  FixPropertyAtomLammps(class LAMMPS *, int, char **);
  ~FixPropertyAtomLammps();
  int setmask();
  void init();
