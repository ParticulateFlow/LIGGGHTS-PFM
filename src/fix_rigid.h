...
class FixRigid : public Fix {
 ...
 friend class FixGravity; //NP modified C.K.
 friend class PairGran; //NP modified C.K.
 friend class FixWallGran; //NP modified C.K.
 ...
 public:
  ...
  virtual double memory_usage();  //NP modified C.K.
  virtual void grow_arrays(int);  //NP modified C.K.
  virtual void copy_arrays(int, int);  //NP modified C.K.
  virtual void set_arrays(int);  //NP modified C.K.
  virtual int pack_exchange(int, double *);  //NP modified C.K.
  virtual int unpack_exchange(int, double *);  //NP modified C.K.

  virtual void pre_neighbor();  //NP modified C.K.
  int dof(int);
  void deform(int);
  void reset_dt();
 ...
 protected:
  ...
  virtual void set_xv();  //NP modified C.K.
  virtual void set_v();  //NP modified C.K.
};
