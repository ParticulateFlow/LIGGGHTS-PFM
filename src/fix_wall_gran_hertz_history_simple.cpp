...
inline void FixWallGranHertzHistorySimple::deriveContactModelParams(int ip, double deltan, double meff_wall, double &kn, double &kt, double &gamman, double &gammat, double &xmu,double &rmu)  //NP modified C.K.
{
