...
FixWallGranHookeSimple::FixWallGranHookeSimple(LAMMPS *lmp, int narg, char **arg) :
  FixWallGranHooke(lmp, narg, arg)
{
...
void FixWallGranHookeSimple::init_granular()
{
  k_n = ((PairGranHookeSimple*)pairgran_)->k_n;
  k_t = ((PairGranHookeSimple*)pairgran_)->k_t;
  gamma_n = ((PairGranHookeSimple*)pairgran_)->gamma_n;
  gamma_t = ((PairGranHookeSimple*)pairgran_)->gamma_t;
  coeffFrict = ((PairGranHookeSimple*)pairgran_)->coeffFrict;
  coeffRollFrict = ((PairGranHookeSimple*)pairgran_)->coeffRollFrict;

  damp_massflag = ((PairGranHookeSimple*)pairgran_)->damp_massflag;
...
inline void FixWallGranHookeSimple::deriveContactModelParams(int ip, double deltan,double meff_wall, double &kn, double &kt, double &gamman, double &gammat, double &xmu,double &rmu, double &vnnr)  //NP modified C.K.
{
