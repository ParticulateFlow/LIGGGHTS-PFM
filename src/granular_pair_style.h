...
namespace PairStyles {
  ...
  public:
    ...
    virtual void compute_force(LAMMPS_NS::PairGran * pg, ContactModels::CollisionData &cdata, ContactModels::ForceData &i_forces, ContactModels::ForceData &j_forces) = 0;//int eflag, int vflag, int addflag) = 0;
