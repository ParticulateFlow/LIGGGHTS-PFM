...
int Input::execute_command()
{
  ...
  else if (!strcmp(command,"thermo_log")) thermo_log(); //NP modified by R.B.
...
void Input::uncompute()
{
  ...
  modify->delete_compute(arg[0],true); //NP modified C.K.
}
...
void Input::unfix()
{
  ...
  modify->delete_fix(arg[0],true); //NP modified C.K.
}
