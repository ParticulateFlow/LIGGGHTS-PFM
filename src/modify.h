...
class Modify : protected Pointers {
 public:
  ...
  int n_iterate_implicitly; //NP modified C.K.
  ...
  virtual void setup_pre_neighbor(); //NP modified C.K.
  ...
  virtual bool iterate_implicitly();  //NP modified C.K.
 ...
 protected:
  ...
  int *list_iterate_implicitly; //NP modified C.K.
