...
class MyPage {
 ...
 public:
  ...
  void reset(bool zeroize_pages) { //NP modified R.B.
    ndatum = nchunk = 0;
    index = ipage = 0;
    page = pages[ipage];
 ...
 private:
  ...
  bool zeroize;   // new pages allocated are initialized with zero //NP modified R.B.
