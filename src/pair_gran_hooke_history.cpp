...
//NP modified C.K.
inline void PairGranHookeHistory::addCohesionForce(int &ip, int &jp,double &r, double &Fn_coh) //NP modified C.K.
{
...
//NP modified C.K.
inline void PairGranHookeHistory::deriveContactModelParams(int &ip, int &jp,double &meff,double &deltan, double &kn, double &kt, double &gamman, double &gammat, double &xmu, double &rmu, double &vnnr) //NP modified C.K.
{
...
void PairGranHookeHistory::compute_force(int eflag, int vflag,int addflag)
{
  ...
  double kn,kt,kr,gamman,gammat,xmu,rmu; //NP modified C.K.
...
void PairGranHookeHistory::settings(int narg, char **arg) //NP modified C.K.
{
    iarg_ = 0;
...
void PairGranHookeHistory::write_restart_settings(FILE *fp) //NP modified C.K.
{
...
void PairGranHookeHistory::read_restart_settings(FILE *fp) //NP modified C.K.
{
  if (comm->me == 0) {
    int readflag;
