...
public:
  NamedIntegerSetting(std::string name, bool default_value) : EnumSetting<int>(name)
  {
...
public:
  ...
  NamedIntegerSetting* registerNamedIntegerSetting(std::string name, int & variable, int default_value = 0)
  {
