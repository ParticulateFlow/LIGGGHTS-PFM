...
inline double vectorMin3D(const double *v,int &dim)
{
    if(v[0] < v[1] && v[0] < v[2])
    {
        dim = 0;
...
inline double vectorMin3D(const double *v)
{
    if(v[0] < v[1] && v[0] < v[2])
    return v[0];
...
inline int vectorMin3D(const int *v)
{
    if(v[0] < v[1] && v[0] < v[2])
    return v[0];
...
inline double vectorMax3D(const double *v)
{
    if(v[0] > v[1] && v[0] > v[2])
    return v[0];
...
inline int vectorMax3D(const int *v)
{
    if(v[0] > v[1] && v[0] > v[2])
    return v[0];
